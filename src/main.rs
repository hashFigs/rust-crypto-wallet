...
// tutorial https://tms-dev-blog.com/build-a-crypto-wallet-using-rust/
...
async fn main() -> Result<()> {
   ...
   // println!("crypto_wallet: {:?}", &crypto_wallet);
    ...
    let endpoint = env::var("GOERLI_URL")?;
    ...
    let transaction = eth_wallet::create_eth_transaction(
        Address::from_str("0xE0bA03AC5FA25021Ea1CD7FB2443aaC7808301bb")?, 0.01);
